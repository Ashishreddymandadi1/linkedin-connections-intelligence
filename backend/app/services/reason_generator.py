...
_BATCH_SYSTEM = (
    ...
    "Do not add employers, skills, dates or claims that are not in their evidence. No generic "
...
def generate_reasons_batch(candidates: list[ScoredCandidate], query: str) -> dict[str, str]:
